...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Guardian Security Solutions");

        jLabel7.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 204, 204));
        jLabel7.setText("copyright © GSS company All rights reserved");
    ...
    public void login() {
        ...
        if (accountController.isAccountExists(id)) {
            Account account = accountController.checkAccByID(id);
            ...
            if (account.getPassword().equals(password)) {
                ...
                if (role.equals("Manager")) {
                    Manager_Frame managerView = new Manager_Frame();
                    managerView.setVisible(true);
                    managerView.pack();
                    managerView.setLocationRelativeTo(null);
                    this.dispose();
                } else if (role.equals("Security")) {
                    SecurityPerson_Frame securityView = new SecurityPerson_Frame();
                    securityView.setVisible(true);
                    securityView.pack();
                    securityView.setLocationRelativeTo(null);
                    this.dispose();
                }
            } else {
                // Invalid password
            ...
            JOptionPane.showMessageDialog(this, "Your account doesn't exist!");
            doClear();
        }
    }
